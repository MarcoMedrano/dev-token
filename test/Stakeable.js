...
contract("DevToken", async accounts => {
    it("Staking 100x2", async () => {
        ...
        console.log("🚀 ~ file: Stakeable.js ~ line 12 ~ it ~ await devToken.balanceOf(owner)", await devToken.balanceOf(owner))
        ...
        console.log("🚀 ~ file: Stakeable.js ~ line 17 ~ it ~ await devToken.balanceOf(owner)", await devToken.balanceOf(owner))
        ...
        console.log("🚀 ~ file: Stakeable.js ~ line 23 ~ it ~ await devToken.balanceOf(owner)", await devToken.balanceOf(owner))
        ...
        stakeID = await devToken.stake(stake_amount, { from: owner });
        console.log("🚀 ~ file: Stakeable.js ~ line 38 ~ it ~ await devToken.balanceOf(owner)", await devToken.balanceOf(owner))
        // Assert on the emittedevent using truffleassert
        // This will capture the event and inside the event callback we can use assert on the values returned
        truffleAssert.eventEmitted(
            stakeID,
    ...
    it("new stakeholder should have increased index", async () => {
        let stake_amount = 100;
        console.log("🚀 ~ file: Stakeable.js ~ line 69 ~ it ~ await devToken.balanceOf(accounts[1])", await devToken.balanceOf(accounts[1]))
